...
node aws-iot-device-sdk-js-v2\samples\node\pub_sub\dist\index.js --endpoint a1mlxh04kxytys-ats.iot.eu-north-1.amazonaws.com --ca_file root-CA.crt --key SebasSeeder.private.key --cert SebasSeeder.cert.pem --client_id sdk-nodejs-v2 --topic sdk/test/js